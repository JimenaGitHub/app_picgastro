class PublicationsController < ApplicationController
  ...
  def create
    ...
    @publication.save
    redirect_to action: :index, notice: "Publication has been created successfylly"
  ...
  def update
    respond_to do |format|
      if @publication.update(publication_params)
        ...
        format.json { render :show, status: :updated, location: @publication }
      else
  ...
  private
    ...
    def publication_params
      params.require(:publication).permit(:title, tags_attibutes:[:name])
    end
end
